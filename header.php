					...
					<div class="mq-logo-login-search">
						<div class="grid-x">
							...
							<div class="small-12 medium-12 large-4 cell">
								<ul class="right inline-list social-login">
									<?php
									if ( ! is_user_logged_in() ) {
										?>
										<li class="hide-for-medium-down login-logout">Member?</li>
										 ...
										 * $current_user->ID
										 * $user_ID, $user_email, $display_name and others.
										 */
										$user_id = $user_ID;
										$greeting = $current_user->user_firstname ? $current_user->user_firstname : $current_user->display_name;
										?>
										<li class="hide-for-medium-down login-logout">Hi,&nbsp; <a href="/account/" style="float:right;"><?php echo $greeting; ?></a></li>
											...
											<div class="top-bar-left">
												...
												if ( has_nav_menu( 'global' ) ) {
													wp_nav_menu(array(
														...
														'container'			=> false,
														'depth'				=> 0,
														'items_wrap'		=> '<ul class="dropdown menu mq-menu align-center" data-dropdown-menu>%3$s</ul>',
